...
| [Тестовое задание на стажировку в Яндекс Директ](https://github.com/AleksandrK86/my_projects/tree/main/yandex_adv_test) | Решение кейса по анализу данных для предполагаемого заказчика-рекламодателя, с предоставлением результата в виде презентации | Excel, DataLens, PowerPoint |
